  ...
  Future resetPassword({required String email}) async {
    try {
      ...
      if (e.toString().contains(
        ...
        snac("Correo electrónico no valido");
      } else {
        snac(e.toString());
      }
    }
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    textNoCuenta("Crear cuenta", () {
                      setState(() {
                        register = true;
                      });
                    }),
                    const SizedBox(height: 10),
                    textNoCuenta("Olvidé mi contraseña", () {
                      setState(() {
                        olvide = true;
                      });
                    }),
                          ...
                          child: SingleChildScrollView(
                            child: Column(
                              children: [
                                ...
                                Text("Elige el rol con el que te registrarás",
                                    style: GoogleFonts.poppins()),
                                SizedBox(
                                  height: 25,
                                ),
