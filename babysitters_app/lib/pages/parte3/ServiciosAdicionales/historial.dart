...
class _HistorialPagePadreState extends State<HistorialPagePadre> {
                            ...
                            children: [
                              ...
                              Column(
                                children: [
                                  GestureDetector(
                                    onTap: () =>
                                        openDialogCalificar(document.id),
                                    child: Text(
                                      (data['cancelado'] == true)
                                          ? ""
                                          : (data['terminado'] == true)
  ...
  Future openDialogCalificar(String uid) => showDialog(
      context: context,
      builder: (context) => AlertDialog(
            ...
            actions: [
              ...
              TextButton(
                onPressed: () async => await updateGrade(context, uid),
                child: Text("Calificar"),
              ),
            ],
          ));

  Future<void> updateGrade(BuildContext context, String uid) async {
    try {
      await _serviceCalifi.doc(uid).update({'calificacion': valor});
